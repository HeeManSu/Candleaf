...
const Products = () => {
    return (
        <div id='products' className='xl:mt-[800px] mt-[710px] '>
            <div id='products' className='text-[#0B254B] -tracking-[0.9px] text-center text-[40px]'>Products</div>
...
const Card = ({ image, name }) => {
    return (
        <Link to="/product"> <div className='sm:w-[250px] w-[320px] h-full shadow-custom'>
